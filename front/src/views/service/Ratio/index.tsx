...
export default function Ratio() {
  ...
  const returnDate = {
    ...
    datasets: [
      {
        label: '40 이하',
        data: [225,148,224,143,142,210,320,240,210,110,260,210],
        borderColor: 'rgba(58,87,232,1)',
        backgroundColor: 'rgba(58,87,232,1)'
      },
      {
      label: '40 초과 60이하',
      data: [100,300,45,310,140,96,255,194,199,134,260,351],
      borderColor: 'rgba(0,203,91,1)',
      backgroundColor: 'rgba(0,203,91,1)'
      },
      {
        label: '60초과 85이하',
        data: [180,150,224,310,134,210,255,240,143,110,260,210],
        borderColor: 'rgba(255,0,255,1)',
        backgroundColor: 'rgba(255,0,255,1)'
      },
      {
        label: '85 초과',
        data: [150,120,224,310,142,66,164,142,210,189,178,141],
  ...
  const leaseRatioDate = {
    ...
    datasets: [
      {
        label: '40 이하',
        data: [225,120,224,310,145,210,177,143,79,110,94,150],
        borderColor: 'rgba(58,87,232,1)',
        backgroundColor: 'rgba(58,87,232,1)'
      },
      {
      label: '40 초과 60이하',
      data: [154,120,56,182,142,94,255,364,156,66,260,210],
      borderColor: 'rgba(0,203,91,1)',
      backgroundColor: 'rgba(0,203,91,1)'
      },
      {
        label: '60초과 85이하',
        data: [225,154,224,310,351,210,255,240,210,145,367,99],
        borderColor: 'rgba(255,0,255,1)',
        backgroundColor: 'rgba(255,0,255,1)'
      },
      {
        label: '85 초과',
        data: [143,154,224,65,142,210,188,240,187,110,260,84],
        borderColor: 'rgba(150,50,55,1)',
        backgroundColor: 'rgba(150,50,55,1)'
      }
      ]
  ...
  const mouthRentRatioDate = {
    ...
    datasets: [
      {
        label: '40 이하',
        data: [91,150,224,310,157,320,255,240,210,110,260,197],
        borderColor: 'rgba(58,87,232,1)',
        backgroundColor: 'rgba(58,87,232,1)'
      },
      {
      label: '40 초과 60이하',
      data: [255,120,224,195,142,210,255,99,164,110,184,210],
      borderColor: 'rgba(0,203,91,1)',
      backgroundColor: 'rgba(0,203,91,1)'
      },
      {
        label: '60초과 85이하',
        data: [110,364,224,310,142,164,255,240,164,110,260,210],
        borderColor: 'rgba(255,0,255,1)',
        backgroundColor: 'rgba(255,0,255,1)'
      },
      {
        label: '85 초과',
        data: [164,120,224,154,142,210,255,254,210,110,260,210],
        borderColor: 'rgba(150,50,55,1)',
        backgroundColor: 'rgba(150,50,55,1)'
      }
      ]
